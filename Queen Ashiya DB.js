...
//Akarsha\\
const botPanel = await GojoMdNx.relayMessage(m.chat, template.message, { messageId: template.key.id })
...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            GojoMdNx.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Gojo-Satoru`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./GojoMedia/HD-wallpaper-little-queen-red-pretty-dress-queen-beautiful-magic-sweet-throne-anime-beauty-anime-girl-long-hair-blue-art-lovely-blonde-hair-swet-cute-girl-purple-crown.jpg`),"sourceUrl": "https://chat.whatsapp.com/LWOdea4zvErAHkLNuAQkoP"}}}, { quoted: m})
        }
...
▮◑${prefix}shio (indo)
▮╚═════════════✪
▮▂▂◤ ${pushname} ◢▂◁💗▷`,unicorn, [{"urlButton": {"displayText": "YouTube💦","url": `${myweb}`}},{"urlButton": {"displayText": "💗Qeen Ashiya🧚","url": `${sc}`}},{"quickReplyButton": {"displayText": "💕Donate🧚","id": 'donate'}},{"quickReplyButton": {"displayText": "🧚Queen Ashiya Owner💕","id": 'owner'}}] )
break
case 'thanksto': case 'tqto': case 'tqtt':
var unicorn = await getBuffer(picak+'Developer')
await GojoMdNx.send5ButImg(from, `` + '' + ' ', `
Thanks to My fiends and my knowledge 💦`,unicorn, [{"urlButton": {"displayText": "YouTube💦","url": `${myweb}`}},{"urlButton": {"displayText": "💗Qeen Ashiya🧚","url": `${sc}`}},{"quickReplyButton": {"displayText": "💕Donate🧚","id": 'donate'}},{"quickReplyButton": {"displayText": "🧚Queen Ashiya Owner💕","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
